...
db-migrate: ## Run Drizzle migrations
	$(BUN) run --filter "@rbac/api" db:migrate

db-seed: ## Seed the database
	$(BUN) run --filter "@rbac/api" db:seed

db-studio: ## Open Drizzle Studio
	$(BUN) run --filter "@rbac/api" db:studio
